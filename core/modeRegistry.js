...
export const modes = [
  ...
  { id: "learn", labelKey: "mode.learn", descKey: "mode.learn.desc", group: "group.learn", map: true, hub: true, load: () => import("../modes/learn/index.js") },
  { id: "explore", labelKey: "mode.explore", descKey: "mode.explore.desc", group: "group.explore", map: true, hub: true, load: () => import("../modes/explore/index.js") },
  { id: "worldmap", labelKey: "mode.worldmap", descKey: "mode.worldmap.desc", group: "group.explore", map: false, hub: true, load: () => import("../modes/worldmap/index.js?v=8") },
