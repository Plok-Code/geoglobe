...
export const modes = [
  ...
  { id: "learn", labelKey: "mode.learn", descKey: "mode.learn.desc", group: "group.learn", map: true, hub: true, load: () => import("../modes/learn/index.js?v=13") },
  { id: "explore", labelKey: "mode.explore", descKey: "mode.explore.desc", group: "group.explore", map: true, hub: true, load: () => import("../modes/explore/index.js?v=13") },
